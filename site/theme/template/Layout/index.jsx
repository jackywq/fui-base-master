...
export default class Layout extends React.Component {
  ...
  render() {
    ...
    const title = 'Ant Design - 一套企业级 UI 设计语言和 React 组件库';
    const description = '基于 Ant Design 设计体系的 React UI 组件库，用于研发企业级中后台产品。';
    return (
      <SiteContext.Provider value={{ isMobile, direction, theme, setTheme, setIframeTheme }}>
        <HelmetProvider context={helmetContext}>
          ...
          <IntlProvider
            ...
            defaultLocale="en-US"
          >
            <ConfigProvider locale={zhCN} direction={direction}>
